...
namespace Saas.Data.Migrations
{
    ...
    [Migration("20220714041959_AddTenantDatalink")]
    partial class AddTenantDatalink
    {
            ...
            modelBuilder.Entity("Saas.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 7, 14, 14, 19, 59, 337, DateTimeKind.Local).AddTicks(3328),
                            Description = "Test Tenant called Alpha",
                            Name = "Alpha",
                            Updated = new DateTime(2022, 7, 14, 14, 19, 59, 337, DateTimeKind.Local).AddTicks(3357)
                        },
                        new
                        {
                            Id = "e7600b12-0c8a-41f1-0f8f-08da5ed157b0",
                            Comment = "This Tenant is for testing purposes only and is not a guenuine company.",
                            Created = new DateTime(2022, 7, 14, 14, 19, 59, 337, DateTimeKind.Local).AddTicks(3360),
                            Description = "Test Tenant called Beta",
                            Name = "Beta",
                            Updated = new DateTime(2022, 7, 14, 14, 19, 59, 337, DateTimeKind.Local).AddTicks(3362)
                        },
                        new
                        {
                            Id = "3eeb9e55-2dea-4e60-0f90-08da5ed157b0",
                            Comment = "This Tenant is for testing purposes only and is not a guenuine company.",
                            Created = new DateTime(2022, 7, 14, 14, 19, 59, 337, DateTimeKind.Local).AddTicks(3363),
                            Description = "Test Tenant called Charlie",
                            Name = "Charlie",
                            Updated = new DateTime(2022, 7, 14, 14, 19, 59, 337, DateTimeKind.Local).AddTicks(3365)
                        },
                        new
                        {
                            Id = "3694cda0-b999-4920-0f91-08da5ed157b0",
                            Comment = "This Tenant is for testing purposes only and is not a guenuine company.",
                            Created = new DateTime(2022, 7, 14, 14, 19, 59, 337, DateTimeKind.Local).AddTicks(3367),
                            Description = "Test Tenant called Delta",
                            Name = "Delta",
                            Updated = new DateTime(2022, 7, 14, 14, 19, 59, 337, DateTimeKind.Local).AddTicks(3368)
                        });
                });
