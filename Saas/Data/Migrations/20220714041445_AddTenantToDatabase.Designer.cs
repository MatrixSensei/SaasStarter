...
namespace Saas.Data.Migrations
{
    ...
    [Migration("20220714041445_AddTenantToDatabase")]
    partial class AddTenantToDatabase
    {
            ...
            modelBuilder.Entity("Saas.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 7, 14, 14, 14, 44, 885, DateTimeKind.Local).AddTicks(9506),
                            Description = "Test Tenant called Alpha",
                            Name = "Alpha",
                            Updated = new DateTime(2022, 7, 14, 14, 14, 44, 885, DateTimeKind.Local).AddTicks(9537)
                        },
                        new
                        {
                            Id = "e7600b12-0c8a-41f1-0f8f-08da5ed157b0",
                            Comment = "This Tenant is for testing purposes only and is not a guenuine company.",
                            Created = new DateTime(2022, 7, 14, 14, 14, 44, 885, DateTimeKind.Local).AddTicks(9540),
                            Description = "Test Tenant called Beta",
                            Name = "Beta",
                            Updated = new DateTime(2022, 7, 14, 14, 14, 44, 885, DateTimeKind.Local).AddTicks(9541)
                        },
                        new
                        {
                            Id = "3eeb9e55-2dea-4e60-0f90-08da5ed157b0",
                            Comment = "This Tenant is for testing purposes only and is not a guenuine company.",
                            Created = new DateTime(2022, 7, 14, 14, 14, 44, 885, DateTimeKind.Local).AddTicks(9543),
                            Description = "Test Tenant called Charlie",
                            Name = "Charlie",
                            Updated = new DateTime(2022, 7, 14, 14, 14, 44, 885, DateTimeKind.Local).AddTicks(9544)
                        },
                        new
                        {
                            Id = "3694cda0-b999-4920-0f91-08da5ed157b0",
                            Comment = "This Tenant is for testing purposes only and is not a guenuine company.",
                            Created = new DateTime(2022, 7, 14, 14, 14, 44, 885, DateTimeKind.Local).AddTicks(9546),
                            Description = "Test Tenant called Delta",
                            Name = "Delta",
                            Updated = new DateTime(2022, 7, 14, 14, 14, 44, 885, DateTimeKind.Local).AddTicks(9547)
                        });
                });
