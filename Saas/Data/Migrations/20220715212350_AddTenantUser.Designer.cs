...
namespace Saas.Data.Migrations
{
    ...
    [Migration("20220715212350_AddTenantUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saas.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 7, 16, 7, 23, 50, 524, DateTimeKind.Local).AddTicks(6942),
                            Description = "Test Tenant called Alpha",
                            Name = "Alpha",
                            Updated = new DateTime(2022, 7, 16, 7, 23, 50, 524, DateTimeKind.Local).AddTicks(6981)
                        },
                        new
                        {
                            Id = "e7600b12-0c8a-41f1-0f8f-08da5ed157b0",
                            Comment = "This Tenant is for testing purposes only and is not a guenuine company.",
                            Created = new DateTime(2022, 7, 16, 7, 23, 50, 524, DateTimeKind.Local).AddTicks(6984),
                            Description = "Test Tenant called Beta",
                            Name = "Beta",
                            Updated = new DateTime(2022, 7, 16, 7, 23, 50, 524, DateTimeKind.Local).AddTicks(6985)
                        },
                        new
                        {
                            Id = "3eeb9e55-2dea-4e60-0f90-08da5ed157b0",
                            Comment = "This Tenant is for testing purposes only and is not a guenuine company.",
                            Created = new DateTime(2022, 7, 16, 7, 23, 50, 524, DateTimeKind.Local).AddTicks(6987),
                            Description = "Test Tenant called Charlie",
                            Name = "Charlie",
                            Updated = new DateTime(2022, 7, 16, 7, 23, 50, 524, DateTimeKind.Local).AddTicks(6988)
                        },
                        new
                        {
                            Id = "3694cda0-b999-4920-0f91-08da5ed157b0",
                            Comment = "This Tenant is for testing purposes only and is not a guenuine company.",
                            Created = new DateTime(2022, 7, 16, 7, 23, 50, 524, DateTimeKind.Local).AddTicks(6995),
                            Description = "Test Tenant called Delta",
                            Name = "Delta",
                            Updated = new DateTime(2022, 7, 16, 7, 23, 50, 524, DateTimeKind.Local).AddTicks(6996)
                        });
                });
            ...
            modelBuilder.Entity("Saas.Models.TenantUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            TenantId = "e895cc49-3266-44a0-0f8e-08da5ed157b0",
                            UserId = "b44ce1a0-06a9-4123-ad57-7cd458485ddc"
                        },
                        new
                        {
                            Id = 2,
                        ...
                        {
                            Id = 4,
                            TenantId = "3694cda0-b999-4920-0f91-08da5ed157b0",
                            UserId = "b44ce1a0-06a9-4123-ad57-7cd458485ddc"
                        });
                });
            ...
            modelBuilder.Entity("Saas.Models.TenantUser", b =>
                {
                    ...
                    b.HasOne("Saas.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
